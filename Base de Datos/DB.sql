...
CREATE TABLE IF NOT EXISTS `Actividades` (
  ...
  `despensasActividad` INT DEFAULT 0,
  `actividadExtra` VARCHAR(1000) NULL,
  `institucionUno` VARCHAR(100) NOT NULL,
  `institucionDos` varchar(100) NULL,
  `voluntarioActividad` VARCHAR(250) NULL,
  `actividadUno` VARCHAR(1000) NULL,
...
CREATE TABLE IF NOT EXISTS `personas` (
  ...
  `FechaNac` DATE NULL,
  `LugarNac` VARCHAR(30) NULL,
  `EstadoCiv` CHAR(1) NOT NULL,
  `CURP` VARCHAR(18) NOT NULL UNIQUE,
  `Escolaridad` CHAR(1) NOT NULL,
  PRIMARY KEY (`idcaso`));
