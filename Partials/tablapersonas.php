    ...
    while($mostrar=mysqli_fetch_array($result)){
      ...
      <tr class="text-center" style="font-size: 13px; background: rgba(255, 0, 0, 0.44);">
        ...
        <td>
          ...
          <button class="btn btn-danger btn-sm" value="<?php echo $mostrar['idcaso'] ?>" type="button" name="<?php echo utf8_encode ($Nombre) ?>" data-toggle="modal" data-target="#borraPersonaM" onclick="borrarPersona(this)">Eliminar Persona</button>
        </td>
